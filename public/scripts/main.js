...
(function() {
  var DONORS, facebookHref, fetch, pinterestHref, renderSubject, renderSubjectList, showImage, talkHref, tumblrHref, twitterHref, updateSubjectList;
  ...
  showImage = function(index) {
    ...
    return $('#subject-images').children().eq(index).css('z-index', 1);
  };
